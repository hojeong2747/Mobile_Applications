...
public final class FoodDB_Impl extends FoodDB {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `food_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `food` TEXT, `nation` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'af1d6148520647ac0806a3ac7cd18b19')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsFoodTable.put("food", new TableInfo.Column("food", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsFoodTable.put("nation", new TableInfo.Column("nation", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoFoodTable.equals(_existingFoodTable)) {
          return new RoomOpenHelper.ValidationResult(false, "food_table(ddwu.mobile.dbtest.roomexam01.Food).\n"
                  + " Expected:\n" + _infoFoodTable + "\n"
                  + " Found:\n" + _existingFoodTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "af1d6148520647ac0806a3ac7cd18b19", "1bdca34753a8919d5dc58e7e158ab2cb");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "food_table");
  }
